...
LCF_INTVEC0_START =	0x800F4000;
LCF_TRAPVEC0_START =	0x80000100;
LCF_TRAPVEC1_START =	0x800F6100;
...
MEMORY
{
	...
	psram1 (wx!p): org = 0x60100000, len = 32K
	
	dsram0_local (w!xp): org = 0xd0000000, len = 72K
	dsram0 (w!xp): org = 0x70000000, len = 72K
	psram0 (wx!p): org = 0x70100000, len = 16K
	
	pfls0 (rx!p): org = 0x80000000, len = 1536K
	pfls0_nc (rx!p): org = 0xa0000000, len = 1536K
	
	dfls0 (rx!p): org = 0xaf000000, len = 1040K
